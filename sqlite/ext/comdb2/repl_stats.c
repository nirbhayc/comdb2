                                  ...
                                  sqlite3_vtab **ppVtab, char **pErr)
{
    ...
    rc = sqlite3_declare_vtab(
        db, "CREATE TABLE comdb2_repl_stats(\"host\", \"port\", "
            "\"bytes_written\", \"bytes_read\", \"throttle_waits\", "
            "\"reorders\", \"avg_wait_over_10secs\", \"avg_wait_over_1min\")");
                                 ...
                                 int pos)
{
    ...
    case COLUMN_HOST:
        ...
        break;
    case COLUMN_PORT:
        sqlite3_result_int(ctx, stats->port);
        break;
